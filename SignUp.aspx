...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head runat="server">
        ...
        * { -webkit-box-sizing:border-box; -moz-box-sizing:border-box; -ms-box-sizing:border-box; -o-box-sizing:border-box; box-sizing:border-box; }
        ...
        .signup h1 { color: #000; text-shadow: 0 0 10px rgba(0,0,0,0.3); letter-spacing:1px; text-align:center; }
    ...
    <body>
        ...
        <div class="signup">
            ...
            <h1>Sign Up</h1>
                Username: <asp:TextBox ID="UserName" runat="server" placeholder="Enter your UserName"></asp:TextBox>
                <asp:RequiredFieldValidator Display="Dynamic" ID="vUserName" runat="server" ControlToValidate="UserName" ErrorMessage="Please enter UserName" ForeColor="Red"/>
                Password: <asp:TextBox ID="Password" type="password" runat="server" placeholder="Enter your Password"></asp:TextBox>
                <asp:RequiredFieldValidator Display="Dynamic" ID="vPassword" runat="server" ControlToValidate="Password" ErrorMessage="Please enter Password" ForeColor="Red"/>
                Email-ID: <asp:TextBox ID="Email" runat="server" placeholder="Enter your Email Address"></asp:TextBox>
                <asp:RequiredFieldValidator Display="Dynamic" ID="vEmail" runat="server" ControlToValidate="Email" ErrorMessage="Please enter Email-Id" ForeColor="Red"></asp:RequiredFieldValidator><br />
                <asp:RegularExpressionValidator Display="Dynamic" ID="vEmail2" runat="server" ErrorMessage="Please Enter Valid Email ID" ControlToValidate="Email" ForeColor="Red" ValidationExpression="\w+([-+.']\w+)*@\w+([-.]\w+)*\.\w+([-.]\w+)*"/>
